...
//	Variable decleration
	...
	public static double e = 0.9; //The coefficient of restitution between the squares
...
//				If in kepler free mode, draw KEPLER, otherwise draw the EARTH mode
				if(keplerMode == 0)
		    	{
		    		g.drawText("EARTH", UtilConstants.SCREEN_WIDTH - menuWidth + 5, UtilConstants.SCREEN_HEIGHT - 4 * menuHeight - 5, 20, Color.rgb(47,79,79));
		        }
				if(keplerMode == 1)
		    	{
		    		g.drawText("SPACE", UtilConstants.SCREEN_WIDTH - menuWidth + 5, UtilConstants.SCREEN_HEIGHT  - 4 * menuHeight - 5, 20, Color.rgb(47,79,79));
		        }
//		    	If in solar system, draw the sun and write the kepler mdoe also
		    	if(keplerMode == 2)
		    	{
		    		g.drawPixmap(sun, (UtilConstants.SCREEN_WIDTH - sun.getWidth())/2, (UtilConstants.SCREEN_HEIGHT - sun.getHeight())/2);
		    		g.drawText("SOLAR", UtilConstants.SCREEN_WIDTH - menuWidth + 5, UtilConstants.SCREEN_HEIGHT - 5 - 4 * menuHeight, 20, Color.rgb(47,79,79));
		        }
